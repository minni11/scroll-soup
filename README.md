...
- **Creators** — `src/data/creators.js` for names/specialties. Creator
  portraits are currently placeholders in `Creators.jsx` — replace the
  `media-placeholder` div with an `<img>` once you have real portraits.
- **Collaborations** — `src/data/collaborations.js`, a plain array of names.
...
src/
  ...
  data/         portfolio, creators, hospitality, collaborations
